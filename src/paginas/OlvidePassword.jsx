  ...
  return (
    <>
      ...
      <form className='my-10 bg-white shadow rounded-lg p-10' onSubmit={handleSubmit}>
        ...
        <input type="submit" value="Enviar Instrucciones" className='bg-sky-700 w-full mb-5 py-3 uppercase font-bold rounded text-white hover:cursor-pointer hover:bg-sky-800 transition-colors' />
      </form>
